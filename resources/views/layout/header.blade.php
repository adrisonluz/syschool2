...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ url('/') }}" class="logo"><b>Aline Rosa</b> | Admin</a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ asset($usuarioLogado->foto == '' ? '/assets/img/default.png' : 'perfil/' . $usuarioLogado->foto ) }}" class="user-image" alt="User Image"/>
