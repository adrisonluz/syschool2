            ...
            <form role="form" action="{{ url('/usuarios/' . $usuario->id ) }}" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control formDate" name="nascimento" placeholder="Data de nascimento" value="{{ data($usuario->nascimento) }}">
                    </div>
                    <div class="form-group">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="password" placeholder="Matricula" type="password"  value="">
                </div>
                <div class="form-group">
                    <label>Nível</label>
    ...
    <div class='col-md-6'>
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div id="imagem-preview" class="activeImg"><canvas id="canvas" width="400" height="300" data-src="{{ asset('perfil/' . $usuario->foto) }}"></canvas></div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group verTurmas">
                    ...
                    <div class="checkbox">
                        <label><input type="checkbox" name="turmas[]" {{ in_array($turma->id, $matriculas) ? "checked" : "" }}  value="{{ $turma->id }}" >&nbsp;{{ $turma->curso->nome }} | {{ $turma->professor->nome }}</label>
                    </div>
                    @endforeach
                    @else
