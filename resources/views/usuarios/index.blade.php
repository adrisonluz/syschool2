                ...
                @if(count($professores) > 0)
                 <table class="table  table-striped tabData" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $professor->id }}</td>
                            <td><a href="usuarios/{{ $professor['id'] }}" title="{{ $professor['nome'] }} perfil ">{{ $professor['nome'] }}</a></td>
                            <td>{{ $professor->celular }}</td>
                            <td>
                            <a href="{{ url('usuarios/' . $professor->id . '/edit/') }}" title="Editar" ><i class="fa fa-edit"></i></a>
                            <a href="{{ url('usuarios/excluir/' . $professor->id) }}" title="Excluir" ><i class="fa fa-trash"></i></a>
                        </td>
                        </tr>
                        @endforeach
                 </tbody>
