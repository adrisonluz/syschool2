...
class AgendaController extends Controller {
    ...
    public function __construct() {
        ...
        $this->mapList = array(
            array('nome' => 'Agenda', 'icon' => 'fa-file-text-o', 'link' => '/' . $this->area)
        );
    }
    ...
    public function store(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            $getVersao = Agenda::where('usuario_id','=',$usuario->id)->get();
            $versao = 1;
            ...
            // redirect
            Session::flash('success', 'Agenda emitido com sucesso!');
    ...
    public function show($id) {
        $contrato = Agenda::find($id);

        if(!$contrato) {
            Session::flash('error', 'Agenda não encontrado.');
            return redirect($this->area);
        }

        $pageTitle = 'Agenda ' . $contrato->usuario->nome. ' v. ' . $contrato->versao;
    ...
    public function destroy($id) {
        ...
        Session::flash('success', 'Agenda excluído com sucesso.');
        return redirect($this->area);
    }
