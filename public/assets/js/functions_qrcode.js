            ...
            $.ajax({
                 ...
                 success: function(result){
                    ...
                    $(json).each(function(i,val){
                        if(val.tipo == 'sucesso'){
                            $('#modalAcessoRegistro .msg').addClass('text-green');
                        }else{
                            $('#modalAcessoRegistro .msg').addClass('text-red');
                        }
                        
                        $('#modalAcessoRegistro .msg').text(val.msg);
                        $('#modalAcessoRegistro img').attr('src' , val.dados.imagem);
                        $('#modalAcessoRegistro .nome span').text(val.dados.nome);
                        $('#modalAcessoRegistro .nivel span').text(val.dados.nivel);
                    });
